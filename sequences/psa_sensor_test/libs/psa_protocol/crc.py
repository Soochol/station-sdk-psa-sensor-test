...
Reference: src/protocol/frame.c (lines 32-65)
...
class CRC8:
    """CRC-8 CCITT calculator (polynomial 0x07)."""

    # Lookup table from firmware (frame.c:32-65)
    _TABLE = [
    ...
    def calculate(cls, data: bytes) -> int:
        """
        Calculate CRC-8 over data bytes.
